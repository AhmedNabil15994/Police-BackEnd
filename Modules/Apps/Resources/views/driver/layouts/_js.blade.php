...
<script>
    ...
    {{--pusher.subscribe('{{ config('core.config.constants.DRIVER_DASHBOARD_CHANNEL') }}').bind('order_location_updated', function (data) {--}}
    {{--        var myhtml = document.createElement("div");--}}
    {{--        myhtml.innerHTML = "Order: #"+ data.order.id + " <br> latitude: " + data.latitude + " <br> longitude: " + data.longitude;--}}
    {{--        swal({--}}
    ...
    pusher.subscribe('user_orders_1157v0e9e9').bind('order_location_updated', function (data) {
            console.log(data);
            // var myhtml = document.createElement("div");
            // myhtml.innerHTML = "Order: #"+ data.order.id + " <br> latitude: " + data.latitude + " <br> longitude: " + data.longitude;
            // swal({
