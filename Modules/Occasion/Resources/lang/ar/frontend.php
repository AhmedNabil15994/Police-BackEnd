...
return [
    ...
    'checkout'  => [
        ...
        'total'         => 'السعر الكلي',
        'validation'    => [
            'order_limit'   => 'نعتذر لك لعدم اتمام الدفع ، يجب الا يقل الطلب من هذا المطعم عن :',
        ],
    ],
    'products'  => [
        'alerts'            => [
...
//            'vendor_not_match'      => 'لا يمكن اضافة هذا المنتج قبل حذف جميع منتجات المطعم الاخر.',
    ...
    'search'    => [
        'index' => [
            'empty' => 'لا يوجد منتجات او فروع لكلمة البحث الخاصة بك',
            'title' => 'نتائج البحث',
        ],
    ],
    'contact_info' => [
