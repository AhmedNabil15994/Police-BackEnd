...
@section('title', __('supplier::dashboard.supplier.routes.create'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('supplier::dashboard.supplier.routes.create')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="form" role="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.supplier.store')}}">
                    @csrf
                    <div class="col-md-12">
