                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$code}}]"
                                                                   ...
                                                                   value="{{ $adGroup->translate($code)->title }}">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2">
                                                    {{ __('advertising::dashboard.advertising_groups.form.item_style.label') }}
                                                </label>
                                                <div class="col-md-9">
                                                    <select name="item_style" class="form-control"
                                                            data-name="item_style">
                                                        <option value="">
                                                            --- {{ __('advertising::dashboard.advertising_groups.alert.select_item_style') }}
                                                            ---
                                                        </option>
                                                        <option
                                                            value="vertical" {{ $adGroup->item_style == 'vertical' ? 'selected' : '' }}>{{ __('advertising::dashboard.advertising_groups.form.item_style.vertical') }}</option>
                                                        <option
                                                            value="horizontal" {{ $adGroup->item_style == 'horizontal' ? 'selected' : '' }}>{{ __('advertising::dashboard.advertising_groups.form.item_style.horizontal') }}</option>
                                                    </select>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
