                                    ...
                                    <div class="tab-content px-1 pt-1">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="item_style" class="form-control" data-name="item_style">
                                                        <option value="">
                                                            --- {{ __('advertising::dashboard.advertising_groups.alert.select_item_style') }}
                                                            ---
                                                        </option>
                                                        <option
                                                            value="vertical">{{ __('advertising::dashboard.advertising_groups.form.item_style.vertical') }}</option>
                                                        <option
                                                            value="horizontal">{{ __('advertising::dashboard.advertising_groups.form.item_style.horizontal') }}</option>
                                                    </select>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
