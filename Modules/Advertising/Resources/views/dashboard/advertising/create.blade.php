                                ...
                                <div class="tab-pane active fade in" id="general">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                @include('core::dashboard.shared.file_upload', ['image' => null, 'name' => 'image_ar', 'imgUploadPreviewID' => 'imgUploadPreviewID-ar'])
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                @include('core::dashboard.shared.file_upload', ['image' => null, 'name' => 'image_en', 'imgUploadPreviewID' => 'imgUploadPreviewID-en'])
                                            </div>
                                        </div>
                                        ...
                                        <div id="advertDurationContent" style="display: none;">
                                            <div class="form-group">
                                                <label class="col-md-2">
