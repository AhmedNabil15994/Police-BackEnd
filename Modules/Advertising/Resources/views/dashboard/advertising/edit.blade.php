                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="general">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('advertising::dashboard.advertising.form.image_ar') }}
                                            </label>
                                            <div class="col-md-9">
                                                @include('core::dashboard.shared.file_upload', ['image' => $advertising->image_ar ?? null, 'name' => 'image_ar', 'imgUploadPreviewID' => 'imgUploadPreviewID-ar'])
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('advertising::dashboard.advertising.form.image_en') }}
                                            </label>
                                            <div class="col-md-9">
                                                @include('core::dashboard.shared.file_upload', ['image' => $advertising->image_en ?? null, 'name' => 'image_en', 'imgUploadPreviewID' => 'imgUploadPreviewID-en'])
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2">
                                                {{ __('advertising::dashboard.advertising.form.advert_time_status') }}
                                            </label>
                                            <div class="col-md-9">
                                                <input type="checkbox" class="make-switch" id="advertTimeStatusCheckbox"
                                                       data-size="small"
                                                       {{ !is_null($advertising->start_at) || !is_null($advertising->end_at) ? ' checked="" ' : ''}}
                                                       name="advert_time_status">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>

                                        <div id="advertDurationContent"
                                             style="display: {{ is_null($advertising->start_at) && is_null($advertising->end_at) ? 'none':'' }}">
                                            <div class="form-group">
                                                <label class="col-md-2">
...
@section('scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#advertTimeStatusCheckbox').on('switchChange.bootstrapSwitch', function (e) {
                $('#advertDurationContent').toggle(e.target.checked);
            });
