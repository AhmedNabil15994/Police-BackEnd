        ...
        <div class="page-content">
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      ...
                      action="{{route('dashboard.subscriptions.update',$subscription->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    ...
                                    <div class="col-md-10">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group input-medium date date-picker"
                                                    ...
                                                    <input type="text" class="form-control" name="start_at"
                                                           value="{{$subscription->start_at}}" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="original_price" class="form-control"
                                                       data-name="price" value="{{$subscription->original_price}}"
                                                       disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="total" class="form-control" data-name="price"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="checkbox" class="make-switch" id="test" data-size="small"
                                                       name="status" {{($subscription->status == 1) ? ' checked="" ' : ''}}>
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
