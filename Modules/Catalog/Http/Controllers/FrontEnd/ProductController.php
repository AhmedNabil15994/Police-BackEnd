...
class ProductController extends Controller
{
    ...
    {
        $product = $this->product->findBySlug($slug, false);
        ...
        $deliveryShippingBranch = !is_null(getCartConditionByName(null, 'company_delivery_fees')) ? getCartConditionByName(null, 'company_delivery_fees')->getAttributes() : null;
...
//            'related_products',
                ...
                'selectedOptions',
                'selectedOptionsValue',
                'currentShippingBranch',
                'deliveryShippingBranch'
            ));
        }
