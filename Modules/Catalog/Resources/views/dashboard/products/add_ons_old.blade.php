                                ...
                                <div class="tab-pane active fade in" id="add_ons">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="mt-radio-inline">
                                                    <label
                                                        class="mt-radio mt-radio-outline"> {{ __('catalog::dashboard.products.form.add_ons.single') }}
                                        ...
                                        <div id="optionsCountRow" class="row" style="display: none;">
                                            <div class="col-md-12">
                                                <div
                                                    class="pull-left">{{ __('catalog::dashboard.products.form.add_ons.customer_can_select_exactly') }}
                                        ...
                                        <a href="javascript:;" style="margin-left: 10px; margin-right: 10px;"
                                           ...
                                           onclick="clearDefaults()">
                                            <i class="fa fa-remove"></i> {{__('catalog::dashboard.products.form.add_ons.clear_defaults')}}
                                        </a>
                                        <a id="resetForm" href="javascript:;"
                                           style="display: none; margin-left: 10px; margin-right: 10px;"
                                           class="pull-right btn btn-primary"
                                           onclick="defaultMode()">
                                            <i class="fa fa-refresh"></i> {{__('catalog::dashboard.products.form.add_ons.reset_form')}}
                                        </a>
...
@section('scripts')
    ...
    <script>
                          ...
                          <div class="modal-dialog" role="document">
                             <div class="modal-content">
                                  <div class="modal-header">
                                        <h5 class="modal-title" id="modalLabel-${data.id}">{{ __('catalog::dashboard.products.form.tabs.add_ons') }} : {{ $product->translate(locale())->title }}</h5>
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div style='margin-bottom: 7px;'>{{__('catalog::dashboard.products.form.add_ons.add_ons_name')}} : <b>${data.name}</b></div>
        ...
        function editMasterOptions(flag = '', rowId, data = {}) {
            ...
            resetForm.show();
            var pTitle = "# {{ __('catalog::dashboard.products.form.tabs.edit_add_ons') }}" + " : " + data.name;
                ...
                item.translations.forEach(function (element, inx) {
                    ...
                    newRow += `<input type="text" class="form-control add_ons_option"
                                ...
                                value="${element.option}"
                                 placeholder="{{__('catalog::dashboard.products.form.add_ons.option')}} - ${element.locale}" autocomplete="off">`;
                });
