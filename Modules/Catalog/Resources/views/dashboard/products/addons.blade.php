                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="add_ons">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div id="addonsLoader" class="text-center"
                                             style="display: none;">{{__('catalog::dashboard.products.form.add_ons.loading')}}</div>
                                        <div id="addonOptionsContent"></div>

                                        <button type="submit" id="submit" class="btn btn-success pull-right">
                                            <i class="fa fa-save"></i> {{__('catalog::dashboard.products.form.add_ons.save_options')}}
                                        </button>
                                        <a href="javascript:;"
                                           id="btnClearDefaults"
                          ...
                          <div class="modal-dialog" role="document">
                             <div class="modal-content">
                                  <div class="modal-header">
                                        <h5 class="modal-title" id="modalLabel-${rowId}">{{ __('catalog::dashboard.products.form.tabs.add_ons') }} : {{ $product->translate(locale())->title }}</h5>
