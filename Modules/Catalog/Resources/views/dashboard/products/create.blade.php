                                    ...
                                    <div id="collapse_2_1" class="panel-collapse in">
                                        <div class="panel-body">
                                            ...
                                            <ul class="nav nav-pills nav-stacked">
                                                ...
                                                <li class="" id="workingTimesTab" style="display: none;">
                        ...
                        <div class="col-md-9">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in" id="workingTimes">
                                    @include('catalog::dashboard.products.working_times._create_times')
                                </div>
...
@section('scripts')
    ...
    <script>
        ...
        var workingTimesRowCountsArray = [0];
