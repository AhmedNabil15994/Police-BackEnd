                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    @endpermission
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.products.export')) }}" class="btn sbold primary">
                                            <i class="fa fa-file-excel-o"></i> {{__('apps::dashboard.general.export')}}
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: "qty", orderable: false, className: 'dt-center',
                            render: function (data, type, row) {
                                return data ? data : '---';
                            }
                        },
