            ...
            @forelse ($res as $key2 => $value2)
                    ...
                    <tr>
                        <td colspan="6" style="padding: 15px;">
                            @foreach ($value2 as $optionValue)
                                ...
                                <span>
                                    {{ $optionValues->findOptionValueById($optionValue, ["translations","option.translations"])->option->translate(locale())->title }} :
                                </span>
                                <b>{{ $optionValues->findOptionValueById($optionValue, ["translations"])->translate(locale())->title }}</b>
                                @if (!$loop->last)
                                    /
                                @endif
                            @endforeach
                ...
                @else
                    <td colspan="6" style="padding: 15px;">
                        ...
                        <span>
                                    {{ $optionValues->findOptionValueById($value2, ["translations","option.translations"])->option->translate(locale())->title }}
                                     : </span>
                        <b>{{ $optionValues->findOptionValueById($value2, ["translations"])->translate(locale())->title }}</b>
