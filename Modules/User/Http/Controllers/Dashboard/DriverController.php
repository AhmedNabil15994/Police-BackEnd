...
class DriverController extends Controller
{
    ...
    function __construct(Driver $driver, Role $role, Vendor $vendor)
    {
        $this->role = $role;
        $this->driver = $driver;
        $this->vendor = $vendor;
    ...
    public function create()
    {
        ...
        $branches = BranchesSelectResource::collection($this->vendor->getAllActive());
        return view('user::dashboard.drivers.create', compact('roles', 'branches'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('user::dashboard.drivers.edit', compact('user', 'roles', 'branches'));
    }
