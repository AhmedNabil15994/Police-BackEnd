...
class OrderRepository
{
    ...
    {
        /*$query = $this->order->whereHas('orderStatus', function ($query) {
            $query->where('flag', '<>', 'failed');
        });*/

        $query = $this->order->successOrders(); // Get All Success Order
    ...
    public function findOrderStatusHistoryById($id)
    {
        return OrderStatusesHistory::find($id);
    }
