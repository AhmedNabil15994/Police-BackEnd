...
class OrderRepository
{
    ...
    {
        $orders = $this->order->with(['orderStatus', 'rate'])->successOrders()->where(function ($q) use ($userOrdersIds) {
    ...
    public function getAllGuestOrders($guestOrdersIds, $userToken, $order = 'id', $sort = 'desc')
    {
        $orders = $this->order->with(['orderStatus', 'rate'])->successOrders()->where(function ($q) use ($guestOrdersIds, $userToken) {
