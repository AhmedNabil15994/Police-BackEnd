<div class="tab-pane fade" id="payment_gateway">
                ...
                <div class="col-md-9">
                    <div class="mt-radio-inline">
                        <label class="mt-radio mt-radio-outline">
                            ...
                            <input type="radio" name="payment_gateway[cbk_payment][payment_mode]" value="test_mode"
                        ...
                        <label class="mt-radio mt-radio-outline">
                            ...
                            <input type="radio" name="payment_gateway[cbk_payment][payment_mode]" value="live_mode"
                                   @if (config('setting.payment_gateway.cbk_payment.payment_mode') == 'live_mode')
                                   checked
                                @endif>
                            <span></span>
    ...
    <div class="row">
        <div class="col-md-7 col-md-offset-2" id="testModelData"
             style="{{ config('setting.payment_gateway.cbk_payment.payment_mode') == 'live_mode' ? 'display: none': 'display: block' }}">

            <h3 class="page-title text-center">CBK Payment Gateway ( Test Mode )</h3>
            <div class="form-group">
                <label>
                    {{ __('setting::dashboard.settings.form.payment_gateway.cbk_payment.client_id') }}
                </label>
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][test_mode][CLIENT_ID]"
                       value="{{ config('setting.payment_gateway.cbk_payment.test_mode.CLIENT_ID') ?? '' }}"/>
            </div>

            <div class="form-group">
                <label>
                    {{ __('setting::dashboard.settings.form.payment_gateway.cbk_payment.client_secret') }}
                </label>
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][test_mode][CLIENT_SECRET]"
                       value="{{ config('setting.payment_gateway.cbk_payment.test_mode.CLIENT_SECRET') ?? '' }}"/>
            </div>

            <div class="form-group">
                <label>
                    {{ __('setting::dashboard.settings.form.payment_gateway.cbk_payment.api_key') }}
                </label>
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][test_mode][ENCRP_KEY]"
                       value="{{ config('setting.payment_gateway.cbk_payment.test_mode.ENCRP_KEY') ?? '' }}"/>
            </div>

            <div class="form-group">
                <label>
                    {{ __('setting::dashboard.settings.form.payment_gateway.cbk_payment.username') }}
                </label>
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][test_mode][USERNAME]"
                       value="{{ config('setting.payment_gateway.cbk_payment.test_mode.USERNAME') ?? '' }}"/>
            </div>

            <div class="form-group">
                <label>
                    {{ __('setting::dashboard.settings.form.payment_gateway.cbk_payment.password') }}
                </label>
                <input type="text" class="form-control"
                       name="payment_gateway[cbk_payment][test_mode][PASSWORD]"
                       value="{{ config('setting.payment_gateway.cbk_payment.test_mode.PASSWORD') ?? '' }}"/>
            </div>

        </div>

        <div class="col-md-7 col-md-offset-2" id="liveModelData"
             style="{{ config('setting.payment_gateway.cbk_payment.payment_mode') == 'live_mode' ? 'display: block': 'display: none' }}">

            <h3 class="page-title text-center">CBK Payment Gateway ( Live Mode )</h3>
            <div class="form-group">
                <label>
                    {{ __('setting::dashboard.settings.form.payment_gateway.cbk_payment.client_id') }}
                </label>
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][live_mode][CLIENT_ID]"
                       value="{{ config('setting.payment_gateway.cbk_payment.live_mode.CLIENT_ID') ?? '' }}"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][live_mode][CLIENT_SECRET]"
                       value="{{ config('setting.payment_gateway.cbk_payment.live_mode.CLIENT_SECRET') ?? '' }}"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][live_mode][ENCRP_KEY]"
                       value="{{ config('setting.payment_gateway.cbk_payment.live_mode.ENCRP_KEY') ?? '' }}"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][live_mode][USERNAME]"
                       value="{{ config('setting.payment_gateway.cbk_payment.live_mode.USERNAME') ?? '' }}"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][live_mode][PASSWORD]"
                       value="{{ config('setting.payment_gateway.cbk_payment.live_mode.PASSWORD') ?? '' }}"/>
            </div>

            {{--<div class="form-group">
                <label>
                    {{ __('setting::dashboard.settings.form.payment_gateway.cbk_payment.iban') }}
                </label>
                <input type="text" class="form-control" name="payment_gateway[cbk_payment][live_mode][IBAN]"
                       value="{{ config('setting.payment_gateway.cbk_payment.live_mode.IBAN') ?? '' }}"/>
            </div>--}}
