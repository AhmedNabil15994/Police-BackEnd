                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$code}}]"
                                                                   ...
                                                                   value="{{ $section->translate($code)->title }}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="description[{{$code}}]" rows="8" cols="80"
                                                                      ...
                                                                      data-name="description.{{$code}}">{{ $section->translate($code)->description }}</textarea>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="seo_keywords[{{$code}}]" rows="8" cols="80"
                                                                      class="form-control"
                                                                      data-name="seo_keywords.{{$code}}">{{ $section->translate($code)->seo_keywords }}</textarea>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="seo_description[{{$code}}]" rows="8"
                                                                      ...
                                                                      data-name="seo_description.{{$code}}">{{ $section->translate($code)->seo_description }}</textarea>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
