...
class VendorServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        App::singleton('defaultRestaurant', function () {
            if (Schema::hasTable('settings'))
         ...
         **/
        View::share(['vendorObject' => app('vendorObject'), 'defaultRestaurant' => app('defaultRestaurant')]);
    }
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            module_path('Vendor', 'Config/config.php'),
            'vendor'
        );
    }
