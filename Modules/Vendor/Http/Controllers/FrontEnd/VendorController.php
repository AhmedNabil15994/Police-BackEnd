...
class VendorController extends Controller
{
    ...
    public function vendorBySection($slug)
    {
        ...
        return redirect()->route('frontend.vendors.section', $section->translate(locale())->slug);
    }
...
//        dd($vendor->toArray(), $categories->toArray());
        ...
        return redirect()->route('frontend.vendors.show', $vendor->translate(locale())->slug);
    }
    ...
    public function askForm($slug)
    {
        ...
        return redirect()->route('frontend.vendors.ask', $vendor->translate(locale())->slug);
    }
    ...
    public function prescriptionForm($slug)
    {
        ...
        return redirect()->route('frontend.vendors.prescription', $vendor->translate(locale())->slug);
    }
    ...
    public function vendorRate(RateRequest $request)
    {
        ...
        if ($order) {
            ...
            return response()->json(["errors" => [__('vendor::webservice.rates.user_not_have_order')]]);
    }
}
