...
return [
    'cart' => [
        'product' => [
            'not_found' => 'This product is not available now :',
            'select_single_addons' => 'Please choose from single product addons',
        ],
    ],
    'validations' => [
        'cart' => [
        ...
        'branch_id' => [
            'required' => 'Enter Branch Id',
            'exists' => 'This Branch is not found',
        ],
        'address_id' => [
