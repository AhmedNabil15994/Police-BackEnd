...
use Modules\Catalog\Console\CheckProductAvailabilitiesCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        CheckProductAvailabilitiesCommand::class,
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('product:checkAvailability')->daily(); // Run the task every minute.
